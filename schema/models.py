...
class UserProfile(BaseModel):
    ...
    annual_income: Optional[float] = Field(None, description="Annual income of the user in USD")
    ...
    existing_coverage: Optional[float] = Field(None, description="Existing life insurance coverage amount in USD")
    ...
    budget: Optional[float] = Field(None, description="Monthly or annual budget for insurance premiums in USD")
...
class ScoringItem(BaseModel):
    ...
    weight: str=Field(description="Weightage of each scoring item")
