...
class PolicyScorer:
    ...
    def evaluate_filters(self, policy: Policy, filters: List[str]) -> Tuple[bool, str]:
        ...
        prompt = (
            ...
            f"Retrieved Context from Policy Documents:\n{context}\n\n"
    ...
    def evaluate_criterion(self, policy: Policy, criterion: ScoringItem) -> Tuple[int, str]:
        ...
        prompt = (
            ...
            f"Retrieved Context from Policy Documents:\n{context}\n\n"
            f"Evaluate the policy against this criterion based on the context. Assign a score out of 5 and provide reasoning."
        )
